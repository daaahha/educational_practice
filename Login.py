...
from tkinter import *
from filter import GuiWindowUser
...
class LoginWindow(tk.Tk):
    def __init__(self):
        ...
        lbl_username = Label(LoginFrame , text="Имя:", font=('arial', 25), bd=18)
        lbl_username.grid(row=1)

        lbl_password = Label(LoginFrame , text="Пароль:", font=('arial', 25), bd=18)
        ...
        btn_login = Button(LoginFrame , text="Авторизация", font=('arial', 18), width=30, command=login)
